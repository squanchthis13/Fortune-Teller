...
def display_rules():
    ...
    msg = Message(rules, text='> Please select a category from the following buttons. \n '
                              ...
                              '> if you are logged in as a returning user and select save from the drop down menu. \n'
...
def love_fortune():
    """Opens the love file and displays fortune"""
...
def career_fortune():
    """Opens career file and displays fortune"""
...
def health_fortune():
    """Opens the health file and displays fortune"""
...
def general_fortune():
    """Opens the general file and displays fortune"""
...
def random_fortune():
    """Opens all fortune files and displays a random fortune"""
